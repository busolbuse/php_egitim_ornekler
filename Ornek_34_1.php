...
//                      _Null koşul ifadesi -get ile


    $gelenisimdegeri = $_GET["kullaniciismi"] ?? "HATA";// ?? den sonra istediğimizi ekleyebiliriz ister başka bir sayfaya yönlendirilsin 
    //kötü amaçlı kullanıcılar input u silebiliyor bunu önlemek için bu şekilde yapılır.
    $gelensoyisimdegeri = $_GET["kullanicisoyismi"]  ?? "HATA";// genelde başka sayfalara yönlendirilir.
